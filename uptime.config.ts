...
const pageConfig: PageConfig = {
  ...
  links: [
    ...
    { link: 'https://atzzz.com/', label: 'Blog' },
    { link: 'mailto:service@exmail.atzzz.com', label: 'Email Me', highlight: true },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  notification: {
    ...
    webhook: {
      ...
      url: 'https://api.telegram.org/7769878605:AAGp544iRz3enCVmmjaOQF4xL70l0V_C8-I/sendMessage',
